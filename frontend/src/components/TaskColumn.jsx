...
export default function TaskColumn({title, tasks}){
    ...
    return(
        <div className="bg-[#ECEDEE] p-4 rounded-lg shadow-md shadow-stone-400 ">
            ...
            <hr className={`my-2 border-2 ${title === "Inprogress" ? "text-sky-500 border-sky-500" : title === "Completed" ? "text-green-500 border-green-500" : "text-red-500 border-red-500"}  sm:mx-auto lg:my-4`} />
